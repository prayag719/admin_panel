        ...
        <div className="mx-auto w-full overflow-hidden rounded-lg bg-gray-100 shadow-xl sm:max-w-sm">
          <div className="relative p-5">
            <div className="text-center">
              ...
              <div>
                <h3 className="text-lg font-medium text-secondary-900">Delete {userInfo?.name}</h3>
                <div className="mt-2 text-sm text-secondary-500">Are you sure you want to delete this user? This action cannot be undone.</div>
              </div>
            </div>
